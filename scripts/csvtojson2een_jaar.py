...
def een_jaar(csv_van, csv_naar, jaar):
    ...
    for line_van, line_naar in zip(csv_van, csv_naar):
        ...
        # find the place 
        data_plaats = {"plaatsnaam":data_van[0], "jaar": {"jaartal": jaar ,"plaatsen_van":plaatsen_van_list, "plaatsen_naar":plaatsen_naar_list}}
        plaatsen.append(data_plaats) 
    plaatsen_js = {"plaatsen":plaatsen}
    return plaatsen_js


csv_van = open('banen_woon_naar_werk.csv', 'r')
csv_naar = open('banen_werk_naar_woon.csv','r')
jsonf = open('data.json', 'w+')

uitkomst = een_jaar(csv_van, csv_naar, "2014")
